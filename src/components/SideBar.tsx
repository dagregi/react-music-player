...
const SideBar = () => {
  ...
  return (
    <section ref={sideRef}>
      ...
      <nav
        className={`flex flex-col fixed inset-y-0 w-3/5 md:w-1/4 min-h-screen items-center bg-opacity-10 backdrop-blur-sm bg-cat-surface0 transform transition-transform z-10 ease-in-out duration-200${hidden ? " translate-x-0" : " -translate-x-full"
          }`}
      >
